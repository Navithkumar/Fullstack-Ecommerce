...
from .views import CreateProductView,ListProductView,UpdateProductView,DeleteProductView,ListProductByUserView,GetProductByIdApiView
...
urlpatterns = [
    ...
    path('get-product/<int:id>/', GetProductByIdApiView.as_view(), name='get-product'),
]
