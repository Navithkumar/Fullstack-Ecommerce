"""
Django settings for orders-backend project.
...
SECRET_KEY = 'django-insecure-v540dwi+-5sj9n+iifv!3@(y4(+55nn57x5c9*i34^-&!t=8l3'
...
ROOT_URLCONF = 'orders-backend.urls'
...
WSGI_APPLICATION = 'orders-backend.wsgi.application'
env = environ.Env()
